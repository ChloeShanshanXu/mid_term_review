## Code referred from:
## https://github.com/EricCharnesky/CIS2001-Winter2022/blob/main/SearchTrees/main.py
...
class BinarySearchTree(BinaryTree):
    ...
    def _contains(self, data, position):
        ...
        return self._contains(data, self._make_osition(node.right))
    ...
    def remove(self, data):
        ...
        if position is None:
            raise ValueError("Data not in the tree")
